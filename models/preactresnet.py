...
def preactresnet34(num_classes):
    return PreActResNet(PreActBasic, [3, 4, 6, 3], class_num=num_classes)

def preactresnet50(num_classes):
    return PreActResNet(PreActBottleNeck, [3, 4, 6, 3], class_num=num_classes)

def preactresnet101(num_classes):
    return PreActResNet(PreActBottleNeck, [3, 4, 23, 3], class_num=num_classes)

def preactresnet152(num_classes):
    return PreActResNet(PreActBottleNeck, [3, 8, 36, 3], class_num=num_classes)
